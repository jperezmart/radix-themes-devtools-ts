...
- [#5](https://github.com/jperezmart/radix-themes-devtools-ts/pull/5) [`cbb31db`](https://github.com/jperezmart/radix-themes-devtools-ts/commit/cbb31db9979c82486cde08b810e6f65bcee24982) Thanks [@jperezmart](https://github.com/jperezmart)! - Document the `0.2.x` -> `0.3.0` upgrade in the package README, with a matching
  migration skill.
